...
export const countries: CountryData[] = [
  ...
  },
  {
    ...
    minimumWage: {
      ...
      effectiveDate: "2025-01-01",
      ageBasedRates: [
        { age: "21+", percentage: 100, hourlyRate: 14.06 },
        { age: "20", percentage: 80, hourlyRate: 11.25 },
        { age: "19", percentage: 60, hourlyRate: 8.44 },
        { age: "18", percentage: 50, hourlyRate: 7.03 },
        { age: "17", percentage: 40, hourlyRate: 5.62 },
        { age: "16", percentage: 35, hourlyRate: 4.92 },
        { age: "15", percentage: 30, hourlyRate: 4.22 },
      ],
    },
    workWeek: { standardHours: 40, maxHours: 48, daysPerWeek: 5 },
    holidays: {
